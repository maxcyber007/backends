...
export async function POST(request) {
  try {
    ...
    const res = await pool.query('INSERT INTO tbl_student (firstname, lastname, username, hashedPassword) VALUES ($1, $2, $3, $4) RETURNING *', [firstname, lastname, username, password]);
